...
public interface IUiAutomationService : IAsyncDisposable
{
    ...
    Task<string> DownloadFileAsync(string fileId, string fileName, CancellationToken cancellationToken = default);
    Task<bool> UploadFileAsync(string folderId, string filePath, CancellationToken cancellationToken = default);
}
